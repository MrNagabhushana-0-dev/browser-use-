...
def main(
	...
	if _write_init_file(output_path, content, force):
		...
		if 'next_steps' in INIT_TEMPLATES[template]:
			...
			next_steps.append('4. Set your model provider key in .env or the environment:\n', style='bold')
			next_steps.append('   OPENAI_API_KEY=... | ANTHROPIC_API_KEY=... | NVIDIA_API_KEY=...\n', style='dim')
			next_steps.append('   (any supported provider; see browser_use/llm/)\n\n', style='dim italic')
